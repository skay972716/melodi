...
import youtubeBlanco from 'assets/img/youtubeblanco.png';
    ...
    return (
        <Flex flexDirection="column" pt={{ base: '120px', md: '75px' }}>
            ...
            <Grid templateColumns={{ md: '1fr', lg: '1fr' }} templateRows={{ md: '1fr auto', lg: '1fr' }} my="26px" gap="24px">
                <BuiltByDevelopers title={'Pedir Música'} name={'¡Tin Tin!'} description={'Pide la música que deseas a nuestro DJ'} />
            </Grid>
            <Grid
